...
class LDELayer(nn.Module):
    def __init__(self):
        ...
        self.conv_rgb2=nn.Sequential(nn.MaxPool2d(1),nn.Conv2d(1024, 64, 3, 1, 1), nn.Conv2d(64, 64,1, 1, 0), self.relu)
...
class Decoder(nn.Module):
    ...
    def forward(self, lde_c,lde_t,rgb_h,rgb_m,depth_h,depth_m,rgb_l,depth_l):
        ...
        edge_rgbd=self.act(self.up2(self.up2(rgb_lde+depth_lde)))
